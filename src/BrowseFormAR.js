...
export default function BrowseForm(){
  ...
  document.body.style.display = "flex";
    ...
    return(
        ...
        <div className="bg-blue-100 w-[80%] sm:w-fit md:fit pb-40 pt-20 md:20 px-20 md:10 h-[570px] sm:h-1/2 justify-center items-center rounded-lg " id="dropArea" onDrop={handleDrop}
  ...
  <li className='list-item font-Tajawal' style={{direction: 'rtl'}}>
    سيتم تصحيح ملفك وإرساله إلى معلمك
        ...
        <form method='post' className='grid mt-6 -ml-10 sm:-m-0' >
          ...
          <input name='key' className='rounded mt-2 w-[70px] sm:w-auto font-Tajawal'style={{direction: 'rtl'}} value= {key} placeholder=" أدخل الرمز..." onChange={e => setKey(e.target.value)}/><br/>
          <input type="submit" className='bg-gradient-to-r from-cyan-500 to-blue-500 rounded w-[70px] sm:w-auto text-white cursor-pointer' style={{marginTop: "10px"}}/>
        </form>
      </div>
      </div>
        </>
